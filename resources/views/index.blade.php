        ...
        <header>
            <div class="navbar navbar-dark bg-dark shadow-sm">
                <div class="container d-flex justify-content-between">
                    <a href="index" class="navbar-brand d-flex align-items-center">      <!-- href変更 -->
                        <strong>顧客管理</strong>
                    </a>
                </div>
            </div>
            ...
            <div class="container-fluid" style="padding-left: 50px;padding-right: 50px;">
                <div class="py-5 text-center">
                    ...
                    <div style="margin-bottom:20px;">
                        ...
                        <div class="form-group row">
                            <a  class="btn btn-success" href="{{ route('create') }}" style="width:150px"><i class="fas fa-chalkboard-teacher pr-1"></i> 新規登録</a>  <!-- href変更 -->
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody id="content">
                                <tr>
                                    <td scope="col">1</td>
                                    <td scope="col"><a href="{{ route('detail', ['id' => 1]) }}">苗字　名前</a></td>      <!-- href変更 -->
                                    ...
                                    <td scope="col">2020/08/30　23：12：34</td>
                                    <td scope="col"><a class="btn btn-info" href="{{ route('edit', ['id' => 1]) }}">編集</a></td>     <!-- href変更 -->
                                </tr>
                            </tbody>
                        </table>
                    </div>
