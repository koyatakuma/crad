            ...
            <div class="container-fluid" style="padding-left: 50px;padding-right: 50px;">
                <div class="py-5 text-center">
                    ...
                    <div style="margin-bottom:20px;">
                        ...
                        <div class="form-group row">
                            <a  class="btn btn-success" href="create" style="width:150px"><i class="fas fa-chalkboard-teacher pr-1"></i> 新規登録</a>  <!-- href変更 -->
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody id="content">
                                <tr>
                                    <td scope="col">1</td>
                                    <td scope="col"><a href="detail">苗字　名前</a></td>      <!-- href変更 -->
                                    ...
                                    <td scope="col">2020/08/30　23：12：34</td>
                                    <td scope="col"><a class="btn btn-info" href="edit">編集</a></td>     <!-- href変更 -->
                                </tr>
                                <tr>
                                    <td scope="col">1</td>
